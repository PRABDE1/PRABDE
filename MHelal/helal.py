...
Bots = []
off =None
ch = "Pythonln" # يوزر قناتك
DEVS = ["PR_ABDE", "Lx0b2"] #يوزرات المطورين المصنع
...
async def alivehi(client: Client, message):
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("𝙶𝚁𝙾𝚄𝙿️", url=f"https://t.me/Pythonln3"),
                InlineKeyboardButton("𝚂𝙾𝚄𝚁𝙲𝙴️", url=f"https://t.me/Pythonln"),
            ],
            [
                 InlineKeyboardButton(f"𝗗𝗘𝗩 ABDE 💎", url=f"https://t.me/PR_ABDE")
            ]
        ]
    )
